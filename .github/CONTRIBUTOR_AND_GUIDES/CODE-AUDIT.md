...
3) [create_lxc.sh](https://github.com/ogizhelev/ProxmoxVE/blob/main/ct/create_lxc.sh): Constructs the LXC container.
...
The installation process uses reusable scripts: [build.func](https://github.com/ogizhelev/ProxmoxVE/blob/main/misc/build.func), [create_lxc.sh](https://github.com/ogizhelev/ProxmoxVE/blob/main/ct/create_lxc.sh), and [install.func](https://github.com/ogizhelev/ProxmoxVE/blob/main/misc/install.func), which are not specific to any particular application.
